...
1. **Proactive summarize** — at clean boundaries, summarize decisions and clear stale context
2. **Save anchors** — write key decisions to a file, then clear context
3. **Branch isolation** — start a fresh session for each distinct task